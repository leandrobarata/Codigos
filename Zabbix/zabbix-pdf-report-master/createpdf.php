...
$pdf->addText(50,34,6,'Gerado por Argo Inteligencia relatorio Zabbix  v' . $version);
$pdf->restoreState();
$pdf->closeObject();
...
$pdf->ezText("",14,array('justification'=>'centre'));
$pdf->ezText(date('l jS \d\e F Y \a\s H:i'),19,array('justification'=>'centre'));
...
$pdf->ezSetDy(-400);
$pdf->ezText("Inicio do relatorio  : $report_start",14,array('justification'=>'right'));
$pdf->ezText("Final do relatorio   : $report_end",14,array('justification'=>'right'));
