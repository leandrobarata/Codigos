...
SetupLocation = "\\ipdoservidor\fusion\" & SetupVersion
...
'
'SetupOptions = "/acceptlicense /runnow /server='http://fusioninventory.cuiaba.mt.gov.br/glpi/plugins/fusioninventory/' /S"
SetupOptions = "/acceptlicense /runnow /server='http://fusioninventory.cuiaba.mt.gov.br/plugins/fusioninventory/' /S"
' Setup
